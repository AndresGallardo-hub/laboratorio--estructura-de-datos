...
# lista_numeros = [1,2,3,4,5,6,7,2,3,4,4,567]
# def reducir_lista(lista_numeros):
#     lista_sin_dulicar = list(set(lista_numeros))
#     lista_reducida = lista_sin_dulicar[:-1]
...
# mensaje = numeros_persona("Andres", 5, 10, 30)
# print(mensaje)
...
#      return len(kwargs)
# resultado = cantidad_atributos(nombre="andres", edad=19, ciudad="Cordoba")
# print(resultado)
...
# atributos = lista_atributos(nombre="Andy", edad=19 , ciudad="Madrid")
# print(atributos)
